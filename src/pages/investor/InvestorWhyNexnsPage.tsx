    ...
    <InvestorShell title="Why NEXNS" subtitle="A fast investor briefing: what NEXNS is, who uses it, what problem it solves, why it grows, and why it is different.">
      ...
      <section className="mt-6 grid gap-6 xl:grid-cols-[1fr_460px]">
        <div className="grid gap-5">
          <NeonNode title="What is NEXNS" copy="A PredictionFi Growth Network where users predict, creators lead attention, projects launch campaigns, and AI companions make growth persistent." icon={BadgeCheck} />
          ...
          <NeonNode title="Why NEXNS is different" copy="It combines PredictionFi, creator distribution, project growth, AI companions, and token value flow instead of treating them as separate products." icon={BrainCircuit} />
        </div>
