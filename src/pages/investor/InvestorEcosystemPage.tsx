...
const pillars: ProofNode[] = [
  ...
  { title: "Growth & Rewards", copy: "EXP, achievements, leaderboards, exclusive rewards.", metric: "$8.6M value distributed through ecosystem rewards.", assumption: "Progression and rewards reinforce productive ecosystem actions.", relationship: "Rewards route value back to users while increasing prediction and task activity.", icon: Gift },
  { title: "Technology Layer", copy: "AI, blockchain security, smart contracts, scalable infrastructure.", metric: "128,560 network transactions and scalable event tracking.", assumption: "Infrastructure must support frequent low-friction user actions.", relationship: "The technology layer enables prediction, identity, rewards, and future settlement paths.", icon: BrainCircuit },
];
