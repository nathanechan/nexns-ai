...
const valueNodes: ProofNode[] = [
  ...
  { title: "Prediction Fees", copy: "Platform fees from prediction activity.", metric: "$24.8M value locked and 128,560 network transactions.", assumption: "High-frequency, low-friction predictions can support recurring fee capture.", relationship: "Fees fund rewards, growth pools, creator economics, and NEX utility.", icon: Coins },
  ...
  { title: "NEX Token", copy: "The value convergence layer.", metric: "1B NEX supply with utility across access, rewards, and governance.", assumption: "Token utility is strongest when tied to repeated product actions.", relationship: "NEX links fees, access, staking, rewards, companion growth, and ecosystem funding.", icon: Lock },
  { title: "Ecosystem", copy: "Value returns through rewards and opportunities.", metric: "$8.6M value distributed and +142% ecosystem growth.", assumption: "Returning value to participants compounds retention and contribution quality.", relationship: "Rewards bring users back, which restarts the value creation cycle.", icon: Gift },
];
