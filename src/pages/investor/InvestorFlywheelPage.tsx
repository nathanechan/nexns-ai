...
const flywheel: ProofNode[] = [
  ...
  { title: "Revenue Generated", copy: "Fees and campaign revenue fund growth.", metric: "$2.48M platform revenue across predictions and campaigns.", assumption: "Small fees plus campaign budgets scale with network participation.", relationship: "Revenue returns through rewards, growth funds, and NEX utility sinks.", icon: Coins },
  { title: "Ecosystem Expands", copy: "More rewards bring more users and creators.", metric: "$18.6M ecosystem value compounds through reinvestment.", assumption: "Reinvestment keeps acquisition, retention, and creator incentives aligned.", relationship: "Expansion restarts the flywheel with higher liquidity and stronger social proof.", icon: BarChart3 },
];
